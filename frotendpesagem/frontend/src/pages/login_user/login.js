...
import { loginUser } from '../../service/login_serice'  // Importando a função de login
...
const Login = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      setInvalidEmail("")
      try {
        const data = await loginUser(values.email, values.password)  // Chama a função de login importada
